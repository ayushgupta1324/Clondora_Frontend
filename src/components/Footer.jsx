    ...
    <div>
      <Box id="footer" paddingBottom={"40px"}>
            ...
            <Box textAlign={"start"} width="90%" margin={"auto"} lineHeight="30px" paddingBottom={"20px"}>
                ...
                <Text fontSize={"14px"} color="grey">Clondora Limited, Development House,Cunninghum Road, Bangalore</Text>
                <Text fontSize={"14px"} color="grey">Registered in India</Text>
                <Text fontSize={"14px"} color="grey">Registered Company Number: 000000</Text>
            </Box>
    </div>
  )
}
